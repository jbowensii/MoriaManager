...
class AboutDialog(DialogIconMixin, ctk.CTkToplevel):  # pylint: disable=too-many-instance-attributes
    """About dialog showing application information with tabbed content."""

    def __init__(self, parent: ctk.CTk):
        super().__init__(parent)

        self.title(f"Help - {__app_name__}")
        ...
        # Initialize attributes to None before _create_widgets()
    ...
    def _show_credits_content(self):
        ...
        # Testers list
        testers = ["Sqitey", "Tobilchiro", "Alligator023", "Jubo"]
